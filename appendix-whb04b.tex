...
On the top row alternatively eithe the step selector percentage is displayed
...
Note that if the theoretical step size as per above table results
...
as pressing the the '+' key in the Feed/Override panel on the screen.
...
When pressed together with the 'Fn' key this button has the same effect
as pressing the the '+' key in the Spindle panel on the screen.
