...
one for a short press of the key and an other one for long press
...
Note that the stepper motor drivers are enabled/disabled when you press
...
If you read carefully you noticed that I said there four step modes but I listed 
five. Thas is no mistake. In 'inch' mode the step mode 'x1000' is skipped and in
...
See \screencap{coordinate-system}{The Coordinate axes} illustrates the coordinate axes. 
...
see Figure~\ref{fig:edge-finder}.


%---------------------------------------------------------------------------
\begin{figure}[htb]
\includegraphics[scale=0.5]{work-offsets-edge-finder.png}
\caption{The Work Offsets screen}
\label{fig:edge-finder}
\end{figure}
%---------------------------------------------------------------------------
...
\screencaps{work-offsets-view-auto}{0.5}{The Work Offsets screen when the PROBE button is activated}
...
Before you can use the probe you need to calibrate the probe tip in the probe calibration screen by activating 
Calibration-button, see 
\screencaps{work-offsets-view-calibrate}{0.5}{The Work Offsets screen when the PROBE button is activated}
