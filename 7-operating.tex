...
real physical world the axes which means that the limits are not reliable
...
see \screencap{work-offsets-view}{The Work Offsets screen.}
...
\subsection{Using an electronic Probe to Touch }

If your system is equiped with an electronic touch probe
you can enable the automatic touch feature by checking the
'Use PROBE to Touch' check box. 

As a safety feature if the 'Use probe to touch' feature is enabled
then the Touch buttons to changed to look like in 
\screencap{work-offsets-view-auto}{The Work Offsets screen when the 'Use PROBE to Touch' is enabled.}
...
After the probe trips it retract to its original position.
...
see \screencap{tool-setup-view}{The Tool Setup screen.} 
...
\screencap{tool-setup-view-auto}{The Tool Setup screen when the 
