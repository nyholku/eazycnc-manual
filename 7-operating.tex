...
\subsection{Coordinates in G-codes} 
...
\end{figure}
%---------------------------------------------------------------------------
\subsection{Selecting the active coordinate system / work offsets}
...
\subsection{Setting the X/Y work offsets via touching}
...
\subsection{Setting the Z work offset via touching}
...
\subsection{Setting the work offsets using an electric probe}
...
\subsection{Setting the works offsets using an electric touch plate}
...
First a few words touch plate which I guess is less familiar to many people.

This is a plate that has two lips on the under side of the edges that allow you to place 
...
so that the cutting touching the plate can be electrically detected. See 
...
place the plate  on top of the work piece taking care to push it agains a corner
of the work piece. 
...
To use the calibration you need to know the widths of the two underside bars of the touch
