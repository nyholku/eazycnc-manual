...
EazyCNC runs on a personal computer  such as an IBM PC compatible 
or a Macintosh computer. These computers use an operating system,
...
These bite size chunks are transferred from the PC to TOAD4 over
...
known position, such as to the end of the movement range,
...
cannot 'carry out the step' and the system loses
...
system to lose its position, so all manual movements
